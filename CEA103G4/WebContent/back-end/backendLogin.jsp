      ...
      <div class="login-box" >
        <form METHOD="post" class="login-form" action="<%=request.getContextPath()%>/loginhandler">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="username" name="account" placeholder="Empno" autofocus><td><font color=red><b>${errorMsgs.empno}</b></td>
          </div>
          <div class="form-group">
            <label class="control-label">密碼：</label>
            <input class="form-control" type="password" name ="password" placeholder="Password" autofocus><td><font color=red><b>${errorMsgs.empPwd}</b></td>
          </div>
          <div class="form-group">
            <div class="utility">
