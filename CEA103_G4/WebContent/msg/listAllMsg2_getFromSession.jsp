...
<%-- 以下等同第8行--%>
<jsp:useBean id="list" scope="session" type="java.util.List<MsgVO>" />

<html>
<head>
<title>所有訊息資料 - listAllMsg2_getFromSession.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有訊息資料 - listAllMsg2_getFromSession.jsp</h3>
