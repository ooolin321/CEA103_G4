...
public class Product_TypeJNDIDAO  implements Product_TypeDAO_interface  {
	...
	public void update(Product_TypeVO product_typeVO){
		...
		try {
			...
			pstmt.setInt(1, product_typeVO.getPdtype_no());
			pstmt.setString(2, product_typeVO.getPdtype_name());
