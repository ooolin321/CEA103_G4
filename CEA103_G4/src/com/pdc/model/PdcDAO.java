...
public class PdcDAO implements PdcDAO_interface {
...
//			pstmt.setByte(7, pdcVO.getProduct_photo());
	...
	public void update(PdcVO pdcVO) {
		...
		try {
			...
			pstmt.setInt(1, pdcVO.getProduct_id());
			pstmt.setString(2, pdcVO.getProduct_name());
			pstmt.setString(3, pdcVO.getProduct_info());
			pstmt.setInt(4, pdcVO.getProduct_price());
			pstmt.setInt(5, pdcVO.getProduct_quantity());
			pstmt.setInt(6, pdcVO.getProduct_remaining());
			pstmt.setString(7, pdcVO.getProduct_state());
//			pstmt.setByte(8, pdcVO.getProduct_photo());
			pstmt.setString(9, pdcVO.getUser_id());
			pstmt.setString(10, pdcVO.getPdtype_id());
			pstmt.setInt(11, pdcVO.getStart_price());
			pstmt.setInt(12, pdcVO.getLive_id());
