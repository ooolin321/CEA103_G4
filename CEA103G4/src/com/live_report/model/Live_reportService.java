...
public class Live_reportService {
	...
	public Live_reportVO addLive_report(String live_report_content, Integer live_no, String user_id, Integer empno,
			Integer live_report_state, java.sql.Date report_date, byte[] photo) {
		...
		live_reportVO.setReport_date(report_date);
	...
	public Live_reportVO updateLive_report(String live_report_content, Integer live_no, String user_id, Integer empno,
			Integer live_report_state, java.sql.Date report_date, byte[] photo, Integer live_report_no) {
		Live_reportVO live_reportVO = new Live_reportVO();
